...
const APP_NAME = Flag.ARENA ? "arena.ai" : "OpenCode"
const APP_CMD = Flag.ARENA ? "arena" : "opencode"
const APP_URL = Flag.ARENA ? "arena.ai" : "opencode.ai"
...
export const TIPS = [
  ...
  `Use {highlight}/undo{/highlight} to revert the last message and any file changes made by ${APP_NAME}.`,
  "Use {highlight}/redo{/highlight} to restore previously undone messages and file changes.",
  `Run {highlight}/share{/highlight} to create a public link to your conversation at ${APP_URL}.`,
  ...
  "Sessions render full-width - there is no pinned side panel to manage.",
  "Press {highlight}Ctrl+X B{/highlight} to open the translucent status panel (context, MCP, LSP, todo).",
  ...
  `Create {highlight}${APP_CMD}.json{/highlight} in project root for project-specific settings.`,
  `Place settings in {highlight}~/.config/${APP_CMD}/${APP_CMD}.json{/highlight} for global config.`,
  ...
  `${APP_NAME} auto-handles OAuth for remote MCP servers requiring auth.`,
  `Add {highlight}.md{/highlight} files to {highlight}.${APP_CMD}/command/{/highlight} to define reusable custom prompts.`,
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  `Add {highlight}.md{/highlight} files to {highlight}.${APP_CMD}/agent/{/highlight} for specialized AI personas.`,
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools.",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions.',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands.',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing.',
  `${APP_NAME} auto-formats files using prettier, gofmt, ruff, and more.`,
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  `${APP_NAME} uses LSP servers for intelligent code analysis.`,
  `Create {highlight}.ts{/highlight} files in {highlight}.${APP_CMD}/tool/{/highlight} to define new LLM tools.`,
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  `Add {highlight}.ts{/highlight} files to {highlight}.${APP_CMD}/plugin/{/highlight} for event hooks.`,
  "Use plugins to send OS notifications when sessions complete.",
  `Create a plugin to prevent ${APP_NAME} from reading sensitive files.`,
  `Use {highlight}${APP_CMD} run{/highlight} for non-interactive scripting.`,
  `Use {highlight}${APP_CMD} run --continue{/highlight} to resume the last session.`,
  `Use {highlight}${APP_CMD} run -f file.ts{/highlight} to attach files via CLI.`,
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  `Run {highlight}${APP_CMD} serve{/highlight} for headless API access to ${APP_NAME}.`,
  `Use {highlight}${APP_CMD} run --attach{/highlight} to connect to a running server for faster runs.`,
  `Run {highlight}${APP_CMD} upgrade{/highlight} to update to the latest version.`,
  `Run {highlight}${APP_CMD} auth list{/highlight} to see all configured providers.`,
  `Run {highlight}${APP_CMD} agent create{/highlight} for guided agent creation.`,
  `Use {highlight}/${APP_CMD}{/highlight} in GitHub issues/PRs to trigger AI actions.`,
  `Run {highlight}${APP_CMD} github install{/highlight} to set up the GitHub workflow.`,
  `Comment {highlight}/${APP_CMD} fix this{/highlight} on issues to auto-create PRs.`,
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews.",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors.',
  `Create JSON theme files in {highlight}.${APP_CMD}/themes/{/highlight} directory.`,
  ...
  `Run {highlight}${APP_CMD} debug config{/highlight} to troubleshoot configuration.`,
